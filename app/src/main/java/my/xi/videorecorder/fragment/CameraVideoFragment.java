...
import my.xi.videorecorder.view.BaseFragment;
...
public abstract class CameraVideoFragment extends BaseFragment {
    ...
    private static final String VIDEO_DIRECTORY_NAME = "CARE_ME";
    ...
    private void showSettingsDialog() {
        ...
        builder.setTitle(getString(R.string.dialog_title_goto_system_permission_settings));
        builder.setMessage(getString(R.string.dialog_message_goto_system_permission_settings));
        builder.setPositiveButton(getString(R.string.dialog_goto_system_settings), (dialog, which) -> {
            dialog.cancel();
            openSettings();
        });
        builder.show();
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        switch (mSensorOrientation) {
            ...
            case SENSOR_ORIENTATION_INVERSE_DEGREES:
                mMediaRecorder.setOrientationHint(INVERSE_ORIENTATIONS.get(3));
                break;
        }
    ...
    public void stopRecordingVideo() throws Exception {
        ...
        Toast.makeText(getActivity(),getString(R.string.saved_success), Toast.LENGTH_SHORT).show();
    }
